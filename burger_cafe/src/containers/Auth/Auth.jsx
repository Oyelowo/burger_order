...
class Auth extends Component {
    ...
    inputChangedHandler = (event, controlName) => {
        ...
        // old way const updatedControls = {     ...this.state.controls,
        // [controlName]: {         ...this.state.controls[controlName],         value:
        // event.target.value,         valid: this.checkValidity(event.target.value,
    ...
    // switchAuthModeHandler = () => {     this.setState(prevState => { return {
    // isSignup: !prevState.isSignup         }     }); } Alternative
    ...
    render() {
        ...
        let form = formElementArray.map(formElement => (<Input
            key={formElement.id}
